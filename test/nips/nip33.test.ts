...
describe.each(engines)("Engine: %s > NIP-33: Parameterized Replaceable Events", (engine) => {
  beforeAll(async () => {
  ...
  test("Parameterized Replaceable events (Kind 30078) follow d-tag replacement logic", async () => {
